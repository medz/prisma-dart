...
class FindUniqueActionClient<
  ...
  FindUniqueActionClient<R, Where, Select, Include> where(Where where) =>
      FindUniqueActionClient(
          RUNTIME_CONTEXT, [..._where, where], _select, _include);

  FindUniqueActionClient<R, Where, Select, Include> select(Select select) =>
      FindUniqueActionClient(
          RUNTIME_CONTEXT, _where, [..._select, select], _include);

  FindUniqueActionClient<R, Where, Select, Include> include(Include include) =>
      FindUniqueActionClient(
