...
export namespace Prisma {
  ...
  */
  ...
  interface UserFieldRefs {
    ...
    readonly price: FieldRef<'User', 'Decimal'>;
    readonly size: FieldRef<'User', 'BigInt'>;
  ...
  export type UserWhereInput = {
    ...
    price?: DecimalFilter<'User'> | Decimal | DecimalJsLike | number | string;
    size?: BigIntFilter<'User'> | bigint | number;
  ...
  export type UserScalarWhereWithAggregatesInput = {
    ...
    price?:
      | DecimalWithAggregatesFilter<'User'>
      | Decimal
      | DecimalJsLike
      | number
      | string;
    size?: BigIntWithAggregatesFilter<'User'> | bigint | number;
