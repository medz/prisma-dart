...
<<< @/../example/codes/create_single_record.dart#snippet
...
<<< @/../example/codes/create_multiple_records.dart#snippet
...
<<< @/../example/codes/get_record_by_unique_field.dart#snippet
...
<<< @/../example/codes/get_all_records.dart#snippet
...
<<< @/../example/codes/get_first_record_that_matches_criteria.dart#snippet
...
<<< @/../example/codes/filter_by_single_field_value.dart#snippet
...
<<< @/../example/codes/filter_by_multiple_field_values.dart#snippet
...
<<< @/../example/codes/filter_by_related_record_field_values.dart#snippet
...
<<< @/../example/codes/select_subset_of_related_record_fields.dart#snippet

### Include related records

The following query returns all `ADMIN` users and includes each user's posts in the result:

<<< @/../example/codes/include_related_records.dart#snippet
...
<<< @/../example/codes/update_single_record.dart#snippet
...
<<< @/../example/codes/update_multiple_records.dart#snippet
...
<<< @/../example/codes/update_or_create_record.dart#snippet
...
<<< @/../example/codes/find_or_create_record.dart#extension

Now you can use `findOrCreate` method:

<<< @/../example/codes/find_or_create_record.dart#snippet
...
<<< @/../example/codes/update_number_field.dart#snippet
...
<<< @/../example/codes/delete_single_record.dart#snippet
...
<<< @/../example/codes/delete_multiple_records.dart#snippet
...
<<< @/../example/codes/delete_all_records.dart#snippet
